...
# exerciseangina
ExerciseAngina=1 if exerciseangina=='Y' else 0  # assigned valriable are taken form original notebook,what the name is been assigned there is taken here
...
if st.button('Predict'):
  ...
  if predictions==1:
    st.error('⚠️High Risk of Heart attack⚠️')
  else:
